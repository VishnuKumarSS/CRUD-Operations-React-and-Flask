...
# FIREBASE CONFIG
FIREBASE_API_KEY: str = os.environ['FIREBASE_API_KEY']
FIREBASE_AUTH_DOMAIN: str = os.environ['FIREBASE_AUTH_DOMAIN']
FIREBASE_PROJECT_ID: str = os.environ['FIREBASE_PROJECT_ID']
FIREBASE_STORAGE_BUCKET: str = os.environ['FIREBASE_STORAGE_BUCKET']
FIREBASE_MESSAGING_SENDER_ID: str = os.environ['FIREBASE_MESSAGING_SENDER_ID']
FIREBASE_APP_ID: str = os.environ['FIREBASE_APP_ID']
FIREBASE_MEASUREMENT_ID: str = os.environ['FIREBASE_MEASUREMENT_ID']
